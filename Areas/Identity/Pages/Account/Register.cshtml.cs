// Лицензия на .NET Foundation находится под одним или несколькими соглашениями.
// .NET Foundation предоставляет вам лицензию на этот файл на условиях лицензии MIT.
#nullable disable
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _userStore.SetUserNameAsync(user, Input.Name, CancellationToken.None); // Используем Name в качестве имени пользователя
